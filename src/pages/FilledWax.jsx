      ...
      <div className="mt-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16 mb-16">
          ...
          <div>
            ...
            <ul className="mx-8 text-sm sm:text-base lg:text-lg text-cyan-950 space-y-2 list-disc pl-6">
              <li>A pattern wax specifically for the production of fine precision type castings.</li>
              <li>A medium viscosity, filled, pattern wax.</li>
              <li>Quick setting wax with minimal cavitations/sink age.</li>
              <li>Can be used as a liquid injection material but performs better if injected at or below the recorded congealing point.</li>
              <li>Capable of producing patterns of all sizes, and thick or thin sections.</li>
              <li>Non-sticky, requiring very little release agent for removal from dies.</li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16 mb-16">
          ...
          <div>
            ...
            <ul className="mx-8 text-sm sm:text-base lg:text-lg text-cyan-950 space-y-2 list-disc pl-6">
              <li>A pattern wax specifically for the production of small and big precision type castings.</li>
              <li>A low viscosity, straight wax compound.</li>
              <li>Good tensile strength.</li>
              <li>Suitable for injection or gravity pouring and ideal for dewaxing.</li>
